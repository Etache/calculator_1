...
public class MainActivity extends AppCompatActivity {
    ...
    private void funNumber(Button[] buttonsNumber) {
        ...
        button1.setOnClickListener(v -> {
            if (tvResult.getText().toString().equals("0")) { tvResult.setText("1"); }
            else { tvResult.setText(tvResult.getText() + "1"); }
        });
        button2.setOnClickListener(v -> {
            if (tvResult.getText().toString().equals("0")) { tvResult.setText("2"); }
            else { tvResult.setText(tvResult.getText() + "2"); }
        });
        button3.setOnClickListener(v -> {
            if (tvResult.getText().toString().equals("0")) { tvResult.setText("3"); }
            else { tvResult.setText(tvResult.getText() + "3"); }
        });
        button4.setOnClickListener(v -> {
            if (tvResult.getText().toString().equals("0")) { tvResult.setText("4"); }
            else { tvResult.setText(tvResult.getText() + "4"); }
        });
        button5.setOnClickListener(v -> {
            if(tvResult.getText().toString().equals("0")) { tvResult.setText("5"); }
            else { tvResult.setText(tvResult.getText() + "5"); }
        });
        button6.setOnClickListener(v -> {
            if (tvResult.getText().toString().equals("0")) { tvResult.setText("6"); }
            else { tvResult.setText(tvResult.getText() + "6"); }
        });
        button7.setOnClickListener(v -> {
            if (tvResult.getText().toString().equals("0")) { tvResult.setText("7"); }
            else { tvResult.setText(tvResult.getText() + "7"); }
        });
        button8.setOnClickListener(v -> {
            if (tvResult.getText().toString().equals("0")) { tvResult.setText("8"); }
            else { tvResult.setText(tvResult.getText() + "8"); }
        });
        button9.setOnClickListener(v -> {
            if (tvResult.getText().toString().equals("0")) { tvResult.setText("9"); }
            else { tvResult.setText(tvResult.getText() + "9"); }
        });
        button0.setOnClickListener(v -> {
            if (tvResult.getText().toString().equals("0")) { tvResult.setText("0"); }
            else { tvResult.setText(tvResult.getText() + "0"); }
        });
